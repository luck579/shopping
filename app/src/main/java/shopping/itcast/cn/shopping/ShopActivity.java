package shopping.itcast.cn.shopping;
...
import shopping.itcast.cn.shopping.database.SQLiteHelper;
...
public class ShopActivity extends Activity implements View.OnClickListener{
    ...
    //商品名称与价格数据集合
    private String[] titles = {"猪饲料", "贤哥", "糖果", "酱鸭", "巧克力", "牛肉粒"};
    private String[] prices = {"53元/箱", "40元/箱", "10元/kg", "65" + "元", "52元", "20元"};
    //图片数据集合
    private int[] icons = {R.drawable.pig, R.drawable.fish, R.drawable.
            sweet, R.drawable.duck, R.drawable.chocolate, R.drawable.beef};
